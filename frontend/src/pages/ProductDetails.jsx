 ...
 * ProductDetails.jsx
 * 
 * page displaying detailed information about a specific product
 * 
 *  Custom tooltip logic was generated by Gemini 3.1 thinking  */
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '48px', alignItems: 'start' }}>
                ...
                <div>
                    ...
                    {priceHistoryData.length > 0 && (
                        <div style={{ marginBottom: '32px', padding: '16px', background: '#fff', border: '1px solid #eaeaea', borderRadius: '12px' }}>


                            <h3 style={{ fontSize: '1rem', marginBottom: '16px', color: '#333' }}>Price History</h3>
                            <div style={{ height: 200 }}>
                                {/* ResponsiveContainer is so the chart fluidly scales up or down as the user resizes */}
                                <ResponsiveContainer width="100%" height="100%" minHeight={200}>
                                    <LineChart data={priceHistoryData} margin={{ top: 15, right: 20, bottom: 5, left: 0 }}>
                                        ...
                                        />
                                        <Line type="monotone" dataKey="price" stroke="#000" strokeWidth={3} dot={{ r: 5, fill: '#000', strokeWidth: 2, stroke: '#fff' }} activeDot={{ r: 9, fill: '#000', stroke: '#fff', strokeWidth: 3 }} />
                                    </LineChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
